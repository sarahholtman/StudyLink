...
const leaveGroupModal =
    document.getElementById("leaveGroupModal");

const leaveSuccessModal =
    document.getElementById("leaveSuccessModal");

const confirmLeaveGroupButton =
    document.getElementById("confirmLeaveGroupButton");

const cancelLeaveGroupButton =
    document.getElementById("cancelLeaveGroupButton");

const returnToDashboardButton =
    document.getElementById("returnToDashboardButton");
...
document.getElementById("viewMembersButton").addEventListener("click", function () {
